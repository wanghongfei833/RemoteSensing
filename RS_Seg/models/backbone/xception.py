...
class Xception(nn.Module):
    ...
    https://arxiv.org/pdf/1610.02357.pdf
    """
    def __init__(self, num_classes=1000, replace_stride_with_dilation=None,in_channel=3):
        """ Constructor
        Args:
        ...
        self.conv1 = nn.Conv2d(in_channel, 32, 3,2, 0, bias=False) # 1 / 2
...
def xception(num_classes=1000, pretrained='imagenet', replace_stride_with_dilation=None,in_channel=3):
    model = Xception(num_classes=num_classes, replace_stride_with_dilation=replace_stride_with_dilation,in_channel=in_channel)
    if pretrained:
